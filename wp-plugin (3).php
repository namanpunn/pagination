...
$zappit_auth_token = "INSERT_BEARER_TOKEN";
    ...
    foreach ($techActions["technical"] as $index => $action) {
        ...
        ?>
                <tr class="bg-white border-t border-gray-200 hover:bg-[#F3F7FD] transition-colors duration-300">
                    <td class="px-6 py-4 text-sm text-gray-800"><?php echo $action_page_id ?></td>            
                    <td class="px-6 py-4 text-sm text-gray-800"><?php echo $action_desc ?></td>
                    <td class="px-6 py-4">
                        <div class="flex justify-center space-x-2">
                            <div id="<?php echo $drawer_id ?>" class="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-300">
                                <div class="bg-white rounded-lg shadow-lg w-full max-w-5xl p-6 relative lg:ml-40">
                                    <!-- Back Button -->
                                    <button id="closeTechnicalDrawer-<?php echo $action_page_id . '-' . $action_desc_slug ?>" data-drawer="<?php echo $drawer_id ?>" class="absolute top-4 left-4 text-gray-600 hover:text-gray-800 flex items-center ml-2 mt-1">
                                <img src="<?php echo $plugin_assets_folder ?>/images/arrow_back.png" alt="" class="w-5 h-5">
                                    </button>

                                    <!-- Content -->
                                    <div class="px-9 py-4 flex flex-col lg:flex-row gap-8">
                                        <!-- Left Section -->
                                        <div class="flex-1">
                                            <h2 class="text-xl font-bold text-[#1D1D1D] mb-4"><?php echo $action_desc ?></h2>
                                            ...
                                            <div class="space-y-3">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="bg-blue-100 text-blue-500 px-4 py-1 rounded-2xl text-sm flex items-center gap-2 font-medium">
                                                    <div class="rounded-full h-2 w-2 bg-blue-700"></div> <?php echo $action_type ?></span>
                                                </div>
                                                <div class="flex items-center">
                                            ...
                                            <!-- Tip Section -->
                                            <div class="flex gap-1 items-center bg-white border rounded-md p-4 shadow-sm mt-3">
                                                <div class="mr-3 ">
                                                    <div class="w-6 h-6 flex items-center justify-center rounded-full bg-gray-100 text-black">
                                                        <img src="<?php echo $plugin_assets_folder ?>/images/tips.png" alt="">
                                                    </div>
                                                </div>
                                                <div>`
                                                    <h4 class="text-sm font-bold text-gray-700">Helpful Tip</h4>
                                                    <p class="text-sm text-gray-600 mt-1">
                                                    Dukaan provides a straightforward way to manage your robots.txt file, ensuring your websites crawling instructions are accurate and efficient.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Right Section -->
                                        <div class="flex-1">
                                            <h3 class="text-lg font-semibold text-gray-800 mt-10 mb-4">How to complete this action</h3>
                                            <ul class="space-y-4 text-sm text-gray-600 border p-5 rounded-lg">
                                                <li class="flex items-center gap-3">
                                                        <img src="<?php echo $plugin_assets_folder ?>/images/check.png" alt="">

                                                    Check your hosting resources: Ensure you have enough bandwidth and server capacity.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <button id="openTechnicalDrawer-<?php echo $action_page_id . '-' . $action_desc_slug ?>" data-drawer="<?php echo $drawer_id ?>" class="border border-blue-500 text-blue-500 px-4 py-2 rounded-lg text-sm hover:bg-blue-100 transition-all duration-300">
                                View Details
                            </button>

                            <script>
                                const technicalDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?> = document.getElementById("technicalDrawer-<?php echo $action_page_id . '-' . $action_desc_slug ?>");
                                const openDrawerButton_<?php echo $action_page_id . '_' . $action_desc_slug ?> = document.getElementById("openTechnicalDrawer-<?php echo $action_page_id . '-' . $action_desc_slug ?>");
                                const closeDrawerButton_<?php echo $action_page_id . '_' . $action_desc_slug ?> = document.getElementById("closeTechnicalDrawer-<?php echo $action_page_id . '-' . $action_desc_slug ?>");

                                // Function to close the drawer
                                const closeDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?> = () => {
                                    technicalDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?>.classList.add("opacity-0", "pointer-events-none");
                                };

                                // Open the drawer
                                openDrawerButton_<?php echo $action_page_id . '_' . $action_desc_slug ?>.addEventListener("click", () => {
                                    technicalDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?>.classList.remove("opacity-0", "pointer-events-none");
                                });

                                // Close the drawer on button click
                                closeDrawerButton_<?php echo $action_page_id . '_' . $action_desc_slug ?>.addEventListener("click", closeDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?>);

                                // Close the drawer when clicking outside
                                technicalDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?>.addEventListener("click", (event) => {
                                    if (event.target === technicalDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?>) {
                                        closeDrawer_<?php echo $action_page_id . '_' . $action_desc_slug ?>();
                                    }
                                });
